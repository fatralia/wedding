	...
	<body>
        ...
        <div class="container" style="margin-top: 60px;">
            <div class="image-container">
              <img class="slide" src="images/grid2.jpg" alt="Image 1">
            </div>
            <div class="content"  style="margin-left: 100px;">
              <div style="margin-bottom: 60px;"><h2>Elegan</h2>
              <p>± Rp. 15.000.000 - Rp. 100.000.000</p></div>
              <div style="margin-bottom: 60px;"><p>Detail : <br>
				- Harga dapat lebih tergantung pada kompleksitas dekorasi, jumlah tamu, dan elemen-elemen tambahan yang diminta.<br>
				- Pertemuan dengan desainer dekorasi untuk merencanakan tema, warna, dan konsep dekorasi yang sesuai dengan gaya elegan yang diinginkan.<br>
				- Dekorasi utama seperti meja pengantin, altar atau pelaminan, latar belakang foto, dan dekorasi untuk tempat resepsi.<br>
				- Penggunaan bunga-bunga segar atau artifisial, serta tanaman hijau untuk menciptakan suasana yang anggun dan mewah. <br>
				- Pencahayaan yang sesuai, termasuk lampu-lampu latar belakang, lilin, atau lampu lantai untuk menambah suasana elegan.<br>
				- perhiasan dan aksesori dekoratif seperti kain drapery, pita, hiasan kristal, atau perak untuk menambah detail yang anggun.<br>
				- Dekorasi meja tamu termasuk tempat duduk, piring, dan sentuhan tambahan untuk menciptakan meja yang indah dan elegan.<br>
				- Pemakaian perlengkapan tambahan seperti tenda, karpet, atau kursi lipat dengan hiasan untuk melengkapi tata letak ruang acara dengan gaya elegan.<br></p></div>
              <a href = "/booking2"><button>Booking Now</button></a>
            </div>
          </div>
          {{-- detail end --}}
