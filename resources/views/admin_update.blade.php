...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link href="css/admin_update.css" rel="stylesheet">
	...
	<body>
        ...
        <div class="button-container">
            <h2 class="title">Admin Update</h2>
            <a href="/admin_prewed" style="text-decoration: none;"><button class="bottom-button">Prewedding Photo</button></a>
            <a href="/admin_decor" style="text-decoration: none;"><button class="bottom-button">Wedding Decoration</button></a>
            <a href="/admin_package" style="text-decoration: none;"><button class="bottom-button">Wedding Package</button></a>
        </div>
        {{-- end button --}}
