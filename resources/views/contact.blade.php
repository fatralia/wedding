  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<body>
		...
		<div class="container">
			...
			<div class="left-text">
				<p>For other questions and other needs, please contact us</p>
			</div>
			<div class="bold-text">
			...
			<div class="contact-info">
				<div class="icon">
					<img src="images/call.png" alt="Telepon" style="width: 30px; height: auto;">
				</div>
				<div class="info">
					<p style="margin-bottom: 0;">+62 897-7926-770</p>
				</div>
			</div>
			<div class="contact-info">
				<div class="icon">
					<img src="images/wa item.png" alt="WhatsApp" style="width: 30px; height: auto;">
				</div>
				<div class="info">
					<p style="margin-bottom: 0;">
					<a href="https://wa.me/6285776844820" target="_blank" style="color : black; text-decoration : none">+62 857-7684-4820</a>
            </p>
				</div>
			</div>
			<div class="contact-info">
				<div class="icon">
					<img src="images/jam.png" alt="Jam" style="width: 30px; height: auto;">
				</div>
				<div class="info">
					<p style="margin-bottom: 0;">Available at 08.00 AM - 20.00 PM </p>
				</div>
			</div>
			<div class="contact-info">
				<div class="icon">
					<img src="images/email.png" alt="Email" style="width: 30px; height: auto;">
				</div>
				<div class="info">
					<p style="margin-bottom: 0;">
					<a href="https://mail.google.com/mail/?view=cm&fs=1&to=fatraayu17@gmail.com" style="color : black; text-decoration : none">moonwedding@gmail.com</a></p>
				</div>
			</div>
		</div>
