...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link href="css/booking3.css" rel="stylesheet">
    ...
    <form action="#">
        ...
        <div class="form-group">
            ...
            <select id="order" name="order">
                ...
                <option value="Traditional">Paket Dasar</option>
                <option value="Vintage Romance">Paket Menengah</option>
                <option value="Nature Adventure">Paket Premium</option>
            </select>
        </div>
        <div class="form-group">
