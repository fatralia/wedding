...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link href="css/detail3.css" rel="stylesheet">
	...
	<body>
        ...
        <div class="container" style="margin-top: 60px;">
            <div class="image-container">
              <img class="slide" src="images/grid3.jpg" alt="Image 1">
            </div>
            <div class="content"  style="margin-left: 100px;">
              <div style="margin-bottom: 60px;"><h2>Paket Dasar</h2>
              <p>± Rp. 20.000.000 - Rp. 80.000.000</p></div>
              <div style="margin-bottom: 60px;"><p>Detail : <br>
				...
				- Prewedding Photo: Sesi foto pranikah di satu atau dua lokasi dengan jumlah foto hasil edit sekitar 30-50 foto.<br>
				- Wedding Decoration: Dekorasi untuk upacara dan resepsi dengan sentuhan sederhana dan pilihan dekorasi yang terbatas.<br>
				- Undangan: Desain undangan digital atau cetak sederhana tanpa banyak tambahan khusus. <br>
				- Souvenir: Souvenir sederhana seperti gantungan kunci atau sendok garpu kayu dengan desain yang standar.<br></p></div>
              <a href = "/booking3"><button>Booking Now</button></a>
            </div>
          </div>
          {{-- detail end --}}
